 ...
 */
'use strict';
App.controller('TagListCtrl', ['$scope', 'InterestService', '$log','$uibModal','UI','alertService','$confirm',function ($scope, InterestService, $log,$uibModal,UI,alertService,$confirm) {
    ...
    //删除兴趣标签
    $scope.onDeleteTagClick = function (id) {
    ...
    //修改时根据id查询兴趣标签
    $scope.onEditTagClick = function (id) {
